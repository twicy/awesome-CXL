...
- **Paper**: [Salus: Efficient Security Support for CXL-Expanded GPU Memory](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10476444)
- **Authors**: Abdullah, Rahaf and Lee, Hyokeun and Zhou, Huiyang and Awad, Amro

### March 2, **HPCA 2024**

- **Paper**: [Computational CXL-Memory Solution for Accelerating Memory-Intensive Applications](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9969883)
...
- **Paper**: [An LPDDR-based CXL-PNM Platform for TCO-Efficient GPT Inference](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10476443)
